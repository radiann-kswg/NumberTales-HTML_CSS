;メッセージレイヤの定義
		...
		;キャラクターの表示モードに関する定義
		[chara_config ptext="chara_name_area" pos_mode=true time="600" memory="false" anim="true" effect="easeInCubic" pos_change_time="600" ]
		...
		;glink_configの設定
		[glink_config auto_place_force="true" width="max" height="max" show_time="600" select_time="600" reject_time="600"]

		
		[glink_config show_effect="fadeInLeft" select_effect="fadeOutRight" reject_effect="fadeOutRight" ]
		

		[glink_config show_easing="ease" select_easing="ease" reject_easing="ease"  place_area="cover"]
